...
3. Deploy canisters  default user !!!!

########################################


YOU CAN ADD Cycles using command line 
#############################################
dfx identity get-principal

dfx canister deposit-cycles 10005000000000 opend_backend 
dfx canister deposit-cycles 10005000000000 nft

dfx canister status opend_backend

dfx wallet --network local balance
dfx wallet --network local add-cycles 1000000000000
...
In the command line, if it asks for *name,  *principal, and *image bytes* separately, you should provide them like this:
